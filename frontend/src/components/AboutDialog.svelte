<script lang="ts">
  ...
  import { GetBuildInfo, OpenConfigFolder, OpenLogsFolder, OpenBugReportURL, CheckForUpdates, RebuildIndex } from '@shared/api'
  import type { BuildInfo, UpdateCheckResult } from '@shared/types'
