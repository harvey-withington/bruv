...
export const GetLocalServerStatus = () => getBackend().GetLocalServerStatus()
...
export const OpenWorkspaceFile = (...args: Parameters<ReturnType<typeof getBackend>['OpenWorkspaceFile']>) => getBackend().OpenWorkspaceFile(...args)
export const StatWorkspaceFile = (...args: Parameters<ReturnType<typeof getBackend>['StatWorkspaceFile']>) => getBackend().StatWorkspaceFile(...args)
export const SaveWorkspaceFile = (...args: Parameters<ReturnType<typeof getBackend>['SaveWorkspaceFile']>) => getBackend().SaveWorkspaceFile(...args)
...
export const RevealWorkspacePath = (...args: Parameters<ReturnType<typeof getBackend>['RevealWorkspacePath']>) => getBackend().RevealWorkspacePath(...args)
export const RunWorkspaceLaunchCommand = (...args: Parameters<ReturnType<typeof getBackend>['RunWorkspaceLaunchCommand']>) => getBackend().RunWorkspaceLaunchCommand(...args)
export const InspectWorkspaceGitServe = (...args: Parameters<ReturnType<typeof getBackend>['InspectWorkspaceGitServe']>) => getBackend().InspectWorkspaceGitServe(...args)
export const EnableWorkspaceGitServe = (...args: Parameters<ReturnType<typeof getBackend>['EnableWorkspaceGitServe']>) => getBackend().EnableWorkspaceGitServe(...args)
export const DisableWorkspaceGitServe = (...args: Parameters<ReturnType<typeof getBackend>['DisableWorkspaceGitServe']>) => getBackend().DisableWorkspaceGitServe(...args)
export const GetWorkspaceCheckout = (...args: Parameters<ReturnType<typeof getBackend>['GetWorkspaceCheckout']>) => getBackend().GetWorkspaceCheckout(...args)
